...
package com.finlite.admin.kotlintrip.cal.date;
...
import com.finlite.admin.kotlintrip.cal.HapticFeedbackController;
import com.finlite.admin.kotlintrip.cal.Utils;
...
public class DatePickerDialog extends DialogFragment implements
    ...
    public int getMinYear() {
        return mDateRangeLimiter.getStartDate().get(Calendar.YEAR);
    }

    @Override
    public int getMaxYear() {
        return mDateRangeLimiter.getEndDate().get(Calendar.YEAR);
    }
